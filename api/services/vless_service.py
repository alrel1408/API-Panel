...
class VLessService:
    ...
    def _add_to_xray_config(self, username, user_uuid, expiry_str):
        ...
        try:
            ...
            # Add to vless section
            vless_user = {
                "id": user_uuid,
                "email": username
            }
            
            # Find vless section and add user
            for inbound in config.get("inbounds", []):
                if inbound.get("protocol") == "vless":
                    ...
                    inbound["settings"]["clients"].append(vless_user)
                    break
    ...
    def _update_xray_config(self, username, new_expiry):
        ...
        # For VLess, expiry is managed in database, not in Xray config
        pass
